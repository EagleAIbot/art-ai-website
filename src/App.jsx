...
function App() {
  ...
  const portfolio = [
    ...
    },
    {
      ...
      partner: "Zeus AI Capital",
      description: "Zeus AI Capital is a private multi-strategy and multi-asset class private fund. Shift AI produces advanced AI automated trading solutions for the fund, delivering fully risk-managed strategies and high returns.",
      tags: ["Multi-Strategy", "AI Trading", "Risk Managed"],
      accent: "#06b6d4",
      logoMark: "ZAC",
      logoPath: "/zeus-ai-logo.png",
      quote: "Shift AI built advanced automated trading systems that align with our risk controls and performance goals.",
      reference: "Zeus AI Capital",
    },
    {
      sector: "Sports",
