  ...
  const portfolio = [
    {
      ...
      description: "Automated Anti-Money Laundering reporting platform built for accountancy firms. Monitors client transaction data, flags suspicious patterns using ML classifiers, and generates regulator-ready AML reports — reducing compliance workload from days to hours.",
    ...
    },
    {
      ...
      description: "End-to-end AI-powered content delivery platform for professional training providers. Courses are scripted, narrated, and delivered by AI avatar instructors — enabling organisations to scale their L&D offering without studio costs or scheduling constraints.",
    ...
    },
    {
      ...
      description: "AI-powered kitchen inventory tracker and meal planning system for fitness-focused consumers. Scans and tracks pantry stock, designs macro-balanced meal plans aligned to individual fitness goals, and generates budget-optimised shopping lists automatically.",
    ...
    },
    {
      ...
      description: "Predictive ML platform that identifies at-risk subscription customers up to 60 days before churn, triggers personalised retention workflows, and surfaces the product usage signals correlated with cancellation — so teams can act before it's too late.",
        ...
        <div className="portfolio-container">
          <motion.div className="section-header" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <p className="portfolio-intro">
              We are sector agnostic. Proven solutions across compliance, learning &amp; development, health &amp; fitness, SaaS, and financial markets.
            </p>
          </motion.div>
            ...
            {portfolio.map((p, i) => (
              <motion.div key={i} className="portfolio-card" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: i * 0.08 }}>
                <div className="portfolio-card-top">
                  ...
                  <div className="portfolio-logo-mark" style={{ color: p.accent }}>
        ...
        <div className="why-us-container">
          ...
          <div className="why-grid">
            {[
              ...
              { title: "Sector agnostic", desc: "We provide proven solutions across compliance, learning & development, health & fitness, SaaS, and financial markets. If there's data and a problem, we can build the AI." },
            ].map((w, i) => (
